...
update_rule_response = events_client.update_rule(
    ...
    update_rule_details=oci.events.models.UpdateRuleDetails(
        condition="{\"eventType\":[\"com.oraclecloud.identitysignon.interactivelogin\"],\"data\":{\"additionalDetails\":{\"ssoIdentityProviderType\":[\"SAML\"]}}}"
        ),
    opc_request_id="ULUP0LSY88Y0NMGXJHB6<unique_ID>")

# Get the data from response
print(update_rule_response.data)
